...
<li><strong>Keys:</strong> arrow keys, the numeric keypad or <kbd>1</kbd>–<kbd>9</kbd> move you; <kbd>Shift</kbd> + direction runs. You can also click on the map to walk there.</li>
...
KEY_HINTS = [
    ...
    ('`', 'Auto-explore: walk to the nearest unexplored spot (dungeons only)'),
...
parts.append(section('about', 'About the game',
                     guide.pop('What makes TinyAngband special')))
...
parts.append('<h2 id="h-version">About this version</h2><ul>'
             '<li>Based on <strong>TinyAngband 1.0.1</strong>.</li>'
             '<li>Original source: <a href="https://github.com/iks3/tinyangband/tree/d221733" target="_blank" rel="noopener">iks3/tinyangband, commit d221733</a></li>'
             '<li>Our changes (port, auto-explore, command menu, web build): '
             '<a href="https://github.com/memmaker/tinyangband/compare/d221733...master" target="_blank" rel="noopener">memmaker/tinyangband</a></li></ul>')
print('\n'.join(parts))
