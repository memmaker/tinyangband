...
extern const cptr angband_bgm_name[];
...
extern int acid_dam(int dam, cptr kb_str, bool aura);
extern int elec_dam(int dam, cptr kb_str, bool aura);
extern int fire_dam(int dam, cptr kb_str, bool aura);
extern int cold_dam(int dam, cptr kb_str, bool aura);
...
extern void bgm(int num);
extern void bgm_dungeon(void);
