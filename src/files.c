...
static void display_player_flag_info(void)
{
	...
	display_player_flag_aux(row++, col, _("耐酸  :", "Acid  :"), 2, TR2_RES_ACID, TR2_IM_ACID, im_f[1], vul_f[1]);
	display_player_flag_aux(row++, col, _("耐電撃:", "Elec  :"), 2, TR2_RES_ELEC, TR2_IM_ELEC, im_f[1], vul_f[1]);
	display_player_flag_aux(row++, col, _("耐火炎:", "Fire  :"), 2, TR2_RES_FIRE, TR2_IM_FIRE, im_f[1], vul_f[1]);
	display_player_flag_aux(row++, col, _("耐冷気:", "Cold  :"), 2, TR2_RES_COLD, TR2_IM_COLD, im_f[1], vul_f[1]);
	display_player_flag_aux(row++, col, _("耐毒  :", "Poison:"), 2, TR2_RES_POIS, 0, im_f[1], vul_f[1]);
	display_player_flag_aux(row++, col, _("耐恐怖:", "Fear  :"), 2, TR2_RES_FEAR, 0, im_f[1], vul_f[1]);
	display_player_flag_aux(row++, col, _("耐暗黒:", "Dark  :"), 2, TR2_RES_DARK, 0, im_f[1], vul_f[1]);
	display_player_flag_aux(row++, col, _("耐盲目:", "Blind :"), 2, TR2_RES_BLIND, 0, im_f[1], vul_f[1]);
	display_player_flag_aux(row++, col, _("耐混乱:", "Conf  :"), 2, TR2_RES_CONF, 0, im_f[1], vul_f[1]);
	display_player_flag_aux(row++, col, _("耐轟音:", "Sound :"), 2, TR2_RES_SOUND, 0, im_f[1], vul_f[1]);
	display_player_flag_aux(row++, col, _("耐地獄:", "Nether:"), 2, TR2_RES_NETHER, 0, im_f[1], vul_f[1]);
...
void process_player_name(bool sf)
{
	...
	/* Cannot be too long */
#if defined(MACINTOSH) || defined(MSDOS) || defined(USE_EMX) || defined(VM)
#ifdef MSDOS
